<?php
     ...
     if (isset($_POST['search'])  && !empty($_POST['email'])){
         ...
         $sql="SELECT id,email,type FROM place_tbl WHERE email = '$mail' && type='Industry'";
...
<div class="container">
        <div class=""><h3>SIWES Organisation</h3></div>
            ...
            <div class="row well-body">
                    <div class="col-sm-4">
                        ...
                        <div class="panel-body">
                            <?php 
                                $sql = "SELECT count(*) as curorg FROM place_tbl WHERE type='Industry' && status='Approved'";
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="panel-body">
                            <?php 
                                $sql = "SELECT count(*) as penorg FROM place_tbl WHERE type='Industry' && status='Pending'";
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="panel-body">
                        <?php 
                            $sql = "SELECT count(*) as allorg FROM place_tbl WHERE type='Industry'";
                            $result = mysqli_query($conn, $sql);
    ...
    $selquery ="SELECT * FROM `place_tbl` WHERE type = 'Industry' ORDER BY name ASC";
...
?>
                    <tbody>
                        ...
                        <td><a href="<?php echo 'read.php?oid='.$aid; ?>"><span class="fa fa-eye btn btn-info"></span></a></td>
